...
http://your-ip/API         root
http://your-ip/health      Health check (DB + Redis status)
http://your-ip/docs        Swagger UI 
http://your-ip/metrics     Prometheus metrics 
http://your-ip:9090        Prometheus dashboard
